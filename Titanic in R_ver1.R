...
# Import data
train <- read.csv("C:\\Users\\Jovan Trajceski\\OneDrive - Hong Kong Baptist University\\R session\\train.csv", header = TRUE, stringsAsFactors = FALSE, na.strings = c("NA", ""))
test <- read.csv("C:\\Users\\Jovan Trajceski\\OneDrive - Hong Kong Baptist University\\R session\\test.csv",  header = TRUE, stringsAsFactors = FALSE, na.strings = c("NA", "") )
